...
export function Recommendations({ productId }: { productId: string }) {
  ...
  return (
    <section className="space-y-5 border-t border-border pt-10">
      <div>
        <h2 className="font-display text-xl font-semibold tracking-tight">More in your queue</h2>
        <p className="text-sm text-muted-foreground">
          Picked from titles you&apos;ve browsed and games players like you bought.
        </p>
      </div>
